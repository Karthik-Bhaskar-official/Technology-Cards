  ...
  <div className="main-container">
    <div className="bg-container">
      ...
      <div className="container">
        <Welcome name={cardsList[0]} key={cardsList[0].id} />
        <Welcome name={cardsList[1]} key={cardsList[1].id} />
        <Welcome name={cardsList[2]} key={cardsList[2].id} />
        <Welcome name={cardsList[3]} key={cardsList[3].id} />
      </div>
    </div>
  </div>
)
